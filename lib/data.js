export const products = [
  ...
  {
    id: 'p5',
    title: 'Emerald Velvet Kurti',
    category: 'Clothing',
    color: 'Green',
    price: 125,
    formattedPrice: 'CAD 125',
    tag: '',
    tagColor: '',
    designer: "ZURAIRA'S COLLECTIONS",
    images: [
    ...
    story: "Rich emerald velvet tailored into a timeless silhouette. Ideal for winter gatherings."
  },
  {
    id: 'p6',
    title: 'Artisan Kundan Necklace',
    category: 'Jewellery',
    color: 'Gold',
    price: 85,
    formattedPrice: 'CAD 85',
    tag: 'Trending',
    tagColor: '#28A745',
    designer: "ZURAIRA'S COLLECTIONS",
    images: [
    ...
    story: "Traditional Kundan craftsmanship meets modern minimalist design."
  },
  {
    id: 'p7',
    title: 'Ivory Organza Dupatta',
    category: 'Accessories',
    color: 'White',
    price: 65,
    formattedPrice: 'CAD 65',
    tag: '',
    tagColor: '',
    designer: "ZURAIRA'S COLLECTIONS",
    images: [
    ...
    story: "A delicate sheer ivory dupatta adorned with fine zardosi borders."
  },
  {
    id: 'p8',
    title: 'Rose Gold Jhumkas',
    category: 'Jewellery',
    color: 'Rose Gold',
    price: 45,
    formattedPrice: 'CAD 45',
    tag: 'Popular',
    tagColor: '#C2185B',
    designer: "ZURAIRA'S COLLECTIONS",
    images: [
      '/images/483863404_1101778851964401_7035531470983658274_n.jpg',
      '/images/483610494_1101778551964431_3889330886213084434_n.jpg',
      '/images/482357944_1101778611964425_180619261892956500_n.jpg'
    ],
    story: "Classic jhumka earrings finished in modern rose gold with tiny pearl drops."
  }
];
